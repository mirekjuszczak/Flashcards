...
using FlashCards.Services.FirebaseService.FirestoreDatabaseService;
...
public static class MauiProgram
{
    ...
    private static void RegisterViewModelsAndPages(MauiAppBuilder builder)
    {
        ...
        builder.Services.AddSingleton<SampleCategoriesCollectionPage>();
        builder.Services.AddSingleton<SampleCategoriesCollectionPageViewModel>();
    }
